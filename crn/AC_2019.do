...
*  - By poverty status
*
* Input file: MEPS HC-216: 2019 Full Year Consolidated Data File
* Input file: MEPS HC-214: 2019 Medical Conditions File
...
* MEPS HC-214: 2019 Medical Conditions File -----------------------------------
use "h214.dta", clear 
...
use h216, clear
rename *, lower
merge 1:1 dupersid using "`MC_2019'"
drop if _merge==2 
drop _merge 
merge 1:1 dupersid using "`PM_2019'"
drop if _merge==2 
...
*family income level
tab povcat19,m
gen poverty=1 if povcat19==1
replace poverty=2 if povcat19>=2&povcat19<=4
replace poverty=3 if povcat19>=5
...
label values inscov19 ins
rename inscov19 inscov
recode insurc19 7/8 = 7, generate(insurance)
...
keep if _merge==3
drop _merge
save "${project}/clean_data/AC_2019.dta",replace 
