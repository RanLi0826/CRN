...
use H181, clear
rename *, lower
merge 1:1 dupersid using "`MC_2015'"
drop if _merge==2 
drop _merge 
merge 1:1 dupersid using "`PM_2015'"
drop if _merge==2 
...
*family income level
tab povcat15,m
gen poverty=1 if povcat15==1
replace poverty=2 if povcat15>=2&povcat15<=4
replace poverty=3 if povcat15>=5
...
label values inscov15 ins
rename inscov15 inscov
recode insurc15 7/8 = 7, generate(insurance)
...
keep if _merge==3
drop _merge
save "${project}/clean_data/AC_2015.dta",replace 
