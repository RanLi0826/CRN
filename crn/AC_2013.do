...
use H163, clear
rename *, lower
merge 1:1 dupersid using "`MC_2013'"
drop if _merge==2 
drop _merge 
merge 1:1 dupersid using "`PM_2013'"
drop if _merge==2 
...
*family income level
tab povcat13,m
gen poverty=1 if povcat13==1
replace poverty=2 if povcat13>=2&povcat13<=4
replace poverty=3 if povcat13>=5
...
gen lowinc=(povcat13<=3)

*insurance 
label define ins 1 "Priv" 2 "Public" 3 "Unins"
label values inscov13 ins
rename inscov13 inscov
recode insurc13 7/8 = 7, generate(insurance)
